...
from app.workers.tasks import enqueue_ingest, ingest_company, run_alerts_eval, snapshot_prices
...
class TestTaskIntegration:
    ...
    def test_ingest_task_with_database(
        self, mock_fetch, db_session, celery_worker, mock_sec_company_tickers, mock_sec_company_facts
    ):
