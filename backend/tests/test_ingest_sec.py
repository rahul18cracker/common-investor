...
class TestFetchJson:
    ...
    def test_fetch_json_success(self, httpx_mock):
        ...
        httpx_mock.add_response(url="https://test.example.com/api/data.json", json=expected_data)
    ...
    def test_fetch_json_404_error(self, httpx_mock):
        ...
        httpx_mock.add_response(url="https://test.example.com/notfound.json", status_code=404)
    ...
    def test_fetch_json_500_error(self, httpx_mock):
        ...
        httpx_mock.add_response(url="https://test.example.com/error.json", status_code=500)
    ...
    def test_fetch_json_includes_user_agent(self, httpx_mock):
        ...
        assert (
            "CommonInvestor" in request.headers["User-Agent"] or "TestCommonInvestor" in request.headers["User-Agent"]
        )
...
class TestTickerMap:
    ...
    def test_ticker_map_success(self, httpx_mock, mock_sec_company_tickers):
        ...
        httpx_mock.add_response(url="https://www.sec.gov/files/company_tickers.json", json=mock_sec_company_tickers)
    ...
    def test_ticker_map_api_failure(self, httpx_mock):
        ...
        httpx_mock.add_response(url="https://www.sec.gov/files/company_tickers.json", status_code=503)
...
class TestCompanyFacts:
    ...
    def test_company_facts_success(self, httpx_mock, mock_sec_company_facts):
        ...
        httpx_mock.add_response(
            url="https://data.sec.gov/api/xbrl/companyfacts/CIK0000789019.json", json=mock_sec_company_facts
        )
    ...
    def test_company_facts_invalid_cik(self, httpx_mock):
        ...
        httpx_mock.add_response(url="https://data.sec.gov/api/xbrl/companyfacts/CIK9999999999.json", status_code=404)
...
class TestDatabaseOperations:
    ...
    def test_upsert_filing_new(self, db_session, create_test_company):
        ...
        filing_id = upsert_filing(
            cik="0000789019", form="10-K", accession="0000789019-23-000030", period_end="2023-06-30"
        )
    ...
    def test_upsert_filing_date_casting(self, db_session, create_test_company):
        ...
        filing_id = upsert_filing(cik="0000789019", form="10-K", accession="TEST-DATE", period_end="2023-12-31")
...
class TestIngestionIntegration:
    ...
    def test_ingest_company_full_workflow(self, db_session, mock_httpx_client, mock_sec_company_facts):
    ...
    def test_ingest_company_invalid_ticker(self, db_session, httpx_mock):
        ...
        httpx_mock.add_response(
            url="https://www.sec.gov/files/company_tickers.json", json={"0": {"cik_str": 789019, "ticker": "MSFT"}}
        )
    ...
    @pytest.mark.slow
    def test_ingest_company_multiple_years(self, db_session, mock_httpx_client, mock_sec_company_facts):
...
class TestEdgeCases:
    ...
    def test_filing_with_null_values(self, db_session, create_test_company):
        ...
        filing_id = upsert_filing(cik="0000789019", form=None, accession="TEST-NULL", period_end=None)
...
class TestIncomeStatementIngestion:
    ...
    def test_ingest_gross_profit(self, db_session, mock_httpx_client, mock_sec_company_facts):
        ...
        stmt = (
            db_session.query(StatementIS)
            .join(Filing)
            .filter(Filing.cik == "0000789019")
            .order_by(StatementIS.fy.desc())
            .first()
        )
    ...
    def test_ingest_cogs(self, db_session, mock_httpx_client, mock_sec_company_facts):
    ...
    def test_ingest_sga(self, db_session, mock_httpx_client, mock_sec_company_facts):
    ...
    def test_ingest_rnd(self, db_session, mock_httpx_client, mock_sec_company_facts):
    ...
    def test_ingest_depreciation(self, db_session, mock_httpx_client, mock_sec_company_facts):
    ...
    def test_ingest_all_is_fields_multi_year(self, db_session, mock_httpx_client, mock_sec_company_facts):
    ...
    def test_gross_margin_calculation_possible(self, db_session, mock_httpx_client, mock_sec_company_facts):
    ...
    def test_operating_margin_calculation_possible(self, db_session, mock_httpx_client, mock_sec_company_facts):
