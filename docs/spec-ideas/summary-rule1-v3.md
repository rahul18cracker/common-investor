...
**Sourcing Notes for Section 2.1 (Meaning) — Practical Playbook**

- **What they do / customers / why they buy:** Extract from **10‑K Item 1 (Business)**; summarize into 2 lines; list products/services & customer segments. Cross‑validate with IR deck description.
- **Industry & cyclicality:** Use **NAICS/SIC** + **historical revenue & gross margin volatility** to label (*Cyclical/Moderate/Defensive*). Optionally corroborate with **FRED/BEA** macro series.
- **Revenue streams (subscription vs usage/hardware/services):** Parse **segment & geography notes**; compute mix when possible; otherwise mark **unknown** and prompt user to attach IR/transcript evidence.
- **Unit economics (ARPU, retention, CAC/LTV):** Rare in 10‑K—pull from **earnings call transcripts** and **Investor Day** slides when disclosed; keep **provenance** (URL, date) and confidence labels. Allow manual override.
- **Key risks:** Classify **10‑K Item 1A** headings into categories (reg, disruption, customer/supplier concentration, FX, litigation). Show original wording + tag(s).
- **Proud to own (10+ yrs):** Provide optional **ESG snapshot** and a free‑text reflection field; this remains a user judgment.
